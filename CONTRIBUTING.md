...
1. Open in a new tab https://github.com/janmaghuyop/pre-thesis-programme
...
```
cd ~/Downloads
git clone git@github.com:username/pre-thesis-programme.git
cd pre-thesis-programme
```

## 3. Set upstream URL
Open the terminal, copy and paste the command(s) below and hit enter.
```
git remote add upstream git@github.com:janmaghuyop/pre-thesis-programme.git
```
